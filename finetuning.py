...
summaries = [
    ...
    "Ashley Stahl recounts a harrowing experience where her father received a scam call claiming she had been kidnapped. Her father, still grieving from the recent loss of Ashley's sister, was terrified and followed the scammer's instructions to avoid harm. Meanwhile, Ashley was unaware, conducting a podcast interview. The police intervened just in time, revealing the scam. This traumatic event led Ashley to reflect on how fear and desperation can cause people to make irrational decisions, akin to how individuals can metaphorically 'kidnap' themselves from their true desires by making fear-based choices. She encourages three steps to reclaim one's power and live authentically: conducting a self-audit to understand one's true feelings, following what genuinely feels good, and taking actionable steps towards desired goals. By connecting to one's true self, joy, and taking decisive actions, individuals can break free from self-imposed limitations and make a 'you-turn' towards a fulfilling life.",
